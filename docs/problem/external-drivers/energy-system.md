...
We will model the following three different parameters for the evaluation of the WDS.
...
The action the participants can do is to install solar pv panels on pump stations at any time, that will have a lifespan of 25 years. The main objective is to achieve low electricity costs in the WDS. As a secondary objective the greenhouse gas emissions produced by the WDS should be minimized.
